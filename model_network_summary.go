...
type NetworkSummary struct {
	Ips                  *map[string]NetworkSummaryIps `json:"ips,omitempty"`
...
func (o *NetworkSummary) GetIps() map[string]NetworkSummaryIps {
	if o == nil || o.Ips == nil {
		var ret map[string]NetworkSummaryIps
		return ret
	}
	return *o.Ips
}
...
// SetIps gets a reference to the given map[string]NetworkSummaryIps and assigns it to the Ips field.
