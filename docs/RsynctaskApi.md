...
func main() {
    ...
    resp, r, err := api_client.RsynctaskApi.RsynctaskGet(context.Background()).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.RsynctaskApi.RsynctaskIdIdDelete(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.RsynctaskApi.RsynctaskIdIdGet(context.Background(), id).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.RsynctaskApi.RsynctaskIdIdPut(context.Background(), id).RsynctaskUpdate1(rsynctaskUpdate1).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.RsynctaskApi.RsynctaskIdIdRunPost(context.Background(), id).Body(body).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.RsynctaskApi.RsynctaskPost(context.Background()).RsynctaskCreate0(rsynctaskCreate0).Execute()
    if err != nil {
