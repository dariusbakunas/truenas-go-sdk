...
func (r ApiCreateShareNFSRequest) Execute() (ShareNFS, *_nethttp.Response, error) {
...
*/
func (a *SharingApiService) CreateShareNFS(ctx _context.Context) ApiCreateShareNFSRequest {
	return ApiCreateShareNFSRequest{
		ApiService: a,
		ctx:        ctx,
	}
 ...
 * @return ShareNFS
 */
func (a *SharingApiService) CreateShareNFSExecute(r ApiCreateShareNFSRequest) (ShareNFS, *_nethttp.Response, error) {
	var (
...
func (r ApiCreateShareSMBRequest) Execute() (ShareSMB, *_nethttp.Response, error) {
...
*/
func (a *SharingApiService) CreateShareSMB(ctx _context.Context) ApiCreateShareSMBRequest {
	return ApiCreateShareSMBRequest{
		ApiService: a,
		ctx:        ctx,
	}
 ...
 * @return ShareSMB
 */
func (a *SharingApiService) CreateShareSMBExecute(r ApiCreateShareSMBRequest) (ShareSMB, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetShareNFSRequest) Execute() (ShareNFS, *_nethttp.Response, error) {
 ...
 */
func (a *SharingApiService) GetShareNFS(ctx _context.Context, id int32) ApiGetShareNFSRequest {
	return ApiGetShareNFSRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
 ...
 * @return ShareNFS
 */
func (a *SharingApiService) GetShareNFSExecute(r ApiGetShareNFSRequest) (ShareNFS, *_nethttp.Response, error) {
	var (
...
func (r ApiGetShareSMBRequest) Execute() (ShareSMB, *_nethttp.Response, error) {
 ...
 */
func (a *SharingApiService) GetShareSMB(ctx _context.Context, id int32) ApiGetShareSMBRequest {
	return ApiGetShareSMBRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
 ...
 * @return ShareSMB
 */
func (a *SharingApiService) GetShareSMBExecute(r ApiGetShareSMBRequest) (ShareSMB, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiListSharesNFSRequest) Execute() ([]ShareNFS, *_nethttp.Response, error) {
 ...
 */
func (a *SharingApiService) ListSharesNFS(ctx _context.Context) ApiListSharesNFSRequest {
	return ApiListSharesNFSRequest{
		ApiService: a,
		ctx:        ctx,
	}
 ...
 * @return []ShareNFS
 */
func (a *SharingApiService) ListSharesNFSExecute(r ApiListSharesNFSRequest) ([]ShareNFS, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiListSharesSMBRequest) Execute() ([]ShareSMB, *_nethttp.Response, error) {
 ...
 */
func (a *SharingApiService) ListSharesSMB(ctx _context.Context) ApiListSharesSMBRequest {
	return ApiListSharesSMBRequest{
		ApiService: a,
		ctx:        ctx,
	}
 ...
 * @return []ShareSMB
 */
func (a *SharingApiService) ListSharesSMBExecute(r ApiListSharesSMBRequest) ([]ShareSMB, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiRemoveShareNFSRequest) Execute() (*_nethttp.Response, error) {
 ...
 */
func (a *SharingApiService) RemoveShareNFS(ctx _context.Context, id int32) ApiRemoveShareNFSRequest {
	return ApiRemoveShareNFSRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
 ...
 * Execute executes the request
 */
func (a *SharingApiService) RemoveShareNFSExecute(r ApiRemoveShareNFSRequest) (*_nethttp.Response, error) {
	var (
...
func (r ApiRemoveShareSMBRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *SharingApiService) RemoveShareSMB(ctx _context.Context, id int32) ApiRemoveShareSMBRequest {
	return ApiRemoveShareSMBRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
 ...
 * Execute executes the request
 */
func (a *SharingApiService) RemoveShareSMBExecute(r ApiRemoveShareSMBRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiUpdateShareNFSRequest) Execute() (ShareNFS, *_nethttp.Response, error) {
 ...
 */
func (a *SharingApiService) UpdateShareNFS(ctx _context.Context, id int32) ApiUpdateShareNFSRequest {
	return ApiUpdateShareNFSRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
 ...
 * @return ShareNFS
 */
func (a *SharingApiService) UpdateShareNFSExecute(r ApiUpdateShareNFSRequest) (ShareNFS, *_nethttp.Response, error) {
	var (
...
func (r ApiUpdateShareSMBRequest) Execute() (ShareSMB, *_nethttp.Response, error) {
 ...
 */
func (a *SharingApiService) UpdateShareSMB(ctx _context.Context, id int32) ApiUpdateShareSMBRequest {
	return ApiUpdateShareSMBRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
 ...
 * @return ShareSMB
 */
func (a *SharingApiService) UpdateShareSMBExecute(r ApiUpdateShareSMBRequest) (ShareSMB, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
