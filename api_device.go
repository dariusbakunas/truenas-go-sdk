...
func (r ApiDeviceGetInfoPostRequest) Execute() (*_nethttp.Response, error) {
 ...
 */
func (a *DeviceApiService) DeviceGetInfoPost(ctx _context.Context) ApiDeviceGetInfoPostRequest {
	return ApiDeviceGetInfoPostRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *DeviceApiService) DeviceGetInfoPostExecute(r ApiDeviceGetInfoPostRequest) (*_nethttp.Response, error) {
	var (
