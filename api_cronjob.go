...
func (r ApiDeleteCronJobRequest) Execute() (*_nethttp.Response, error) {
 ...
 */
func (a *CronjobApiService) DeleteCronJob(ctx _context.Context, id int32) ApiDeleteCronJobRequest {
	return ApiDeleteCronJobRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
 ...
 * Execute executes the request
 */
func (a *CronjobApiService) DeleteCronJobExecute(r ApiDeleteCronJobRequest) (*_nethttp.Response, error) {
	var (
...
func (r ApiUpdateCronJobRequest) Execute() (CronJob, *_nethttp.Response, error) {
 ...
 */
func (a *CronjobApiService) UpdateCronJob(ctx _context.Context, id int32) ApiUpdateCronJobRequest {
	return ApiUpdateCronJobRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
 ...
 * @return CronJob
 */
func (a *CronjobApiService) UpdateCronJobExecute(r ApiUpdateCronJobRequest) (CronJob, *_nethttp.Response, error) {
	var (
