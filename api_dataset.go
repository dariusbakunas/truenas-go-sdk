...
func (r ApiDeleteDatasetRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *DatasetApiService) DeleteDataset(ctx _context.Context, id string) ApiDeleteDatasetRequest {
	return ApiDeleteDatasetRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
 ...
 * Execute executes the request
 */
func (a *DatasetApiService) DeleteDatasetExecute(r ApiDeleteDatasetRequest) (*_nethttp.Response, error) {
	var (
...
func (r ApiUpdateDatasetRequest) Execute() (Dataset, *_nethttp.Response, error) {
 ...
 */
func (a *DatasetApiService) UpdateDataset(ctx _context.Context, id string) ApiUpdateDatasetRequest {
	return ApiUpdateDatasetRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
 ...
 * @return Dataset
 */
func (a *DatasetApiService) UpdateDatasetExecute(r ApiUpdateDatasetRequest) (Dataset, *_nethttp.Response, error) {
	var (
